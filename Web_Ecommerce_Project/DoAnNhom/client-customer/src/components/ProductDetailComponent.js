  ...
  render() {
    ...
    if (prod != null) {
      return (
        ...
        <div className="align-center-detail">
              ...
              <form>
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td></td>
                      <td><input type="submitr" value="ADD TO CART" onClick={(e) => this.btnAdd2CartClick(e)} /></td>
                    </tr>
                  </tbody>
                </table>
                <h2>Mô Tả</h2>
                <p>Lorem ipsum dolor sit, amet consectetur <br />
                  adipisicing elit. Laborum,quasi animi n<br />
                  saepe possimus quo,quasi animi natus n<br />
                  quasi animi natus nulla beatae neque sol
                </p>
              </form>
            </figcaption>
          </figure>
