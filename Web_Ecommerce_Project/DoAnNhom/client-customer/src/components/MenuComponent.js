...
class Menu extends Component {
  ...
  render() {
    ...
    return (
      <div className="border-bottom-nav">
        <div className="float-left">
          <ul className="menu" id='top'>
            <li className="menu"><Link to='/'>Home</Link></li>
            <li className="menu"><Link to='/about'>About</Link></li> {/* Add this line */}
            <li className="menu"><Link to='/blog'>Blog</Link></li> {/* Add this line */}
            <li className="menu"><Link to='/contactus'>Contact</Link></li> {/* Add this line */}
            {cates}
          </ul>
        </div>
