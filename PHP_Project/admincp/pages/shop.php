    ...
    <div id="page-header">
      ...
      <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
          <div class="pro">
            <img src="hinh/f1.jpg" alt="">
            <div class="des">
              <span>Cara</span>
              <h5>Cara Winter Jacket</h5>
              <h4>450,000 VNĐ</h4>
            </div>
            <a href="thongtin.php"><i class="fa-sharp fa-solid fa-bag-shopping "></i></a> 
          </div>
          <div class="pro">
            <img src="hinh/f2.jpg" alt="">
            <div class="des">
              <span>Cara</span>
              <h5>Cara Winter Jacket</h5>
              <h4>450,000 VNĐ</h4>
          ...
          <div class="pro">
            <img src="hinh/f7.jpg" alt="">
            <div class="des">
              <span>Cara</span>
              <h5>Cara Women Pant </h5>
              <h4>450,000 VNĐ</h4>
            </div>
            <a href="thongtin.php"><i class="fa-sharp fa-solid fa-bag-shopping "></i></a> 
          </div>
          <div class="pro">
            <img src="hinh/f8.jpg" alt="">
            <div class="des">
              <span>Cara</span>
              <h5>Cara Women T-Shirt</h5>
              <h4>450,000 VNĐ</h4>
            </div>
            <a href="thongtin.php"><i class="fa-sharp fa-solid fa-bag-shopping "></i></a> 
          </div>
          <div class="pro">
            <img src="hinh/f9.jpg" alt="">
            <div class="des">
              <span>Cara</span>
              <h5>Cara Winter Jacket</h5>
              <h4>450,000 VNĐ</h4>
...
<section id="pagination" class="section-p1">
    ...
    <a href="3.php">3</a>
    <a href="4.php">4</a>
    <a href="2.php"><i class="fa-solid fa-arrow-right"></i></a>
</section>
